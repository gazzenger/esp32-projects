...
class Evo60m : public PollingComponent, public Sensor {
 public:
  ...
  */
  ...
  // constructor
  Evo60m() : PollingComponent(5000) {}

  void setup() override {
    // This will be called by App.setup()

    Wire.begin(4,5);           // Join I2C bus as master
  ...
  void update() override {
    ...
    // if (CRC == buf[2]) {                  // If the function crc8 return the same checksum than the TeraRanger, then:
      ...
      ESP_LOGD("custom", "The value of sensor is: %d, %d", this->buf[0], this->buf[1]);
    // }
    // else {
    //   publish_state(42);
    // }
