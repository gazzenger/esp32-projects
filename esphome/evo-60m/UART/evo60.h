...
class Evo60m : public PollingComponent,  public UARTDevice, public sensor::Sensor{
 public:
  Evo60m(UARTComponent *parent) : PollingComponent(100), UARTDevice(parent) {}
  ...
  */
  ...
  uint8_t Framereceived[BUFF_LEN];// The variable "Framereceived[]" will contain the frame sent by the TeraRanger
  ...
  void update() override {
    // ESP_LOGD("custom", "The value of sensor is: %d", this->distance);
